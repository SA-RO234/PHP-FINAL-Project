                ...
                <div class="card mb-3 mb-md-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 mb-md-4 d-flex justify-content-between">
                            <div class="h3 mb-0">Create New Student</div>
                        </div>


                        <!-- Form -->
                        <div>
                            <form method="POST" enctype="multipart/form-data" id="registerStudent">
                                <div class="form-row">
                                    <div class="form-group col-12 col-md-6">
                                        <label for="name">Student /Name</label>
                                        <input type="text" class="form-control border border-primary" id="name" name="studentname" placeholder="Student Name">
                                    </div>
                                    <div class="form-group col-12 col-md-6">
                                        <label for="email">Student /Email</label>
                                        <input type="email" class="form-control border border-primary" id="email" name="Email" placeholder="Student Email">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-12 col-md-6">
                                        <label for="Province">Province /City:</label><span style="color: red !important; display: inline; float: none;">*</span>
                                        <select name="Province" id="Province" required class="form-control border border-primary">
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <input type="date" class="form-control border border-primary" id="date" name="date">
                                    </div>
                                </div>
                                ...
                                <div class="form-row mt-3 ">
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <select id="country" name="country" class="form-control border border-primary">
                                ...
                                <div class="form-row">
                                     <div class="form-group col-12 col-md-6">
                                        <label for="course">Learn /Course :</label>
                                         <select name="course" id="" class="form-control border border-primary">
                                             <?php
                                ...
                                <div class="form-row mt-3">
                                    ...
                                    <!-- <img src="/grains-master/image/user-286.png" alt=""> -->
                                </div>
                                <button type="submit" class="btn btn-primary float-right " id="Create_Student">Create</button>
                            </form>
                        </div>
                        <!-- End Form -->
                    </div>
